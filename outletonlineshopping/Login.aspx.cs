...
namespace outletonlineshopping
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request.Cookies["UEmail"] != null && Request.Cookies["UPWD"] != null)
                {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), "randomtext", "alertuserinvalid()", true);
            }
            clr();
        }
        public void clr()
        ...
        private void SendEmail(string useremail)
        {
            ...
            try
            {
                ...
                sb.Append("<a href=http://localhost:4849/resetlink.aspx?username=" + useremail);
